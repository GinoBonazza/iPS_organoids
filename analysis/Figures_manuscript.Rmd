...
nrow(filter(signif_JDR, avg_log2FC > 0.25))
nrow(filter(signif_JDR, avg_log2FC < -0.25))

signif_JD6 <- filter(DE_JD6, abs(avg_log2FC) > 0.5 & p_val_adj < 0.05)

nrow(filter(signif_JD6, avg_log2FC > 0.25))
nrow(filter(signif_JD6, avg_log2FC < -0.25))
...
keyvals <- rep("grey", nrow(DE_JDR))
  ...
  keyvals[DE_JDR$avg_log2FC > 0.25 & DE_JDR$p_val_adj < 0.01] <- "#A63A2A"
  names(keyvals)[keyvals == "#A63A2A"] <- "Increased"
  keyvals[DE_JDR$avg_log2FC < -0.25 & DE_JDR$p_val_adj < 0.01] <- "#004C8C"
...
keyvals <- rep("grey", nrow(DE_JD6))
  ...
  keyvals[DE_JD6$avg_log2FC > 0.25 & DE_JD6$p_val_adj < 0.01] <- "#A63A2A"
  names(keyvals)[keyvals == "#A63A2A"] <- "Increased"
  keyvals[DE_JD6$avg_log2FC < -0.25 & DE_JD6$p_val_adj < 0.01] <- "#004C8C"
  names(keyvals)[keyvals == "#004C8C"] <- "Decreased"
