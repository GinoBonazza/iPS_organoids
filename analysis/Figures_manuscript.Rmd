...
```{r , fig.height=6, fig.width=7, message=FALSE}
props <- getTransformedProps(iPS_integrated$cell_type, iPS_integrated$Sample2, transform="logit")
...
props <- getTransformedProps(iPS_integrated$cell_type,
                             iPS_integrated$Sample2,
                             transform = "logit")

par(mar = c(5, 5, 1, 22), xpd = TRUE)        # big bottom margin for angled labels
...
## legend as before
legend("topright", inset = c(-1.55, 0.2),
       legend = rownames(props$Proportions),
       fill   = cell_type_cols,
       bty    = "n",
       cex    = 1.6)
...
```{r}
iPS_integrated@meta.data[iPS_integrated@meta.data$Sample %in% c("JDR_Ctr"), "Sample3"] = "CTRL1"
iPS_integrated@meta.data[iPS_integrated@meta.data$Sample %in% c("JDR_DMD"), "Sample3"] = "DMD1"
iPS_integrated@meta.data[iPS_integrated@meta.data$Sample %in% c("JD6_Ctr"), "Sample3"] = "CTRL2"
iPS_integrated@meta.data[iPS_integrated@meta.data$Sample %in% c("JD6_DMD"), "Sample3"] = "DMD2"
iPS_integrated$Sample3 <- factor(iPS_integrated$Sample3, levels = c("CTRL1", 
                                                                        "DMD1",
                                                                        "CTRL2",
                                                                        "DMD2"))
```
