...
iPS_integrated@meta.data[iPS_integrated@meta.data$integrated_snn_res.0.2 %in% c("3"), "cell_type"] = "Unspecified cells"
...
dfsample$`Unspecified cells` = bitr(dfsample$`Unspecified cells`, fromType="SYMBOL", toType="ENTREZID", OrgDb="org.Hs.eg.db")
...
genelist <- list("Atrial Cardiomyocytes" = dfsample$`Atrial Cardiomyocytes`$ENTREZID, 
                 ...
                 "Unspecified cells" = dfsample$`Unspecified cells`$ENTREZID,
...
dotplot(GO_MF_simplified, label_format = 40, title = "GO Over-representation analysis") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```

```{r Barplot_Sample, fig.height=6, fig.width=9, message=FALSE}
color_palette <- c("#24B700","#F8766D", "#D575FE", "#00ACFC", "#EA8331", "#FF65AC")
