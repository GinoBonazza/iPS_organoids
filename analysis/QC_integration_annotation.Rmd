...
ggsave(here::here(output_dir_data, "cell_type_sample_table.png"), plot = table_plot, dpi = 600, width = 8, height = 3)

# Include the image in the markdown document
knitr::include_graphics(here::here(output_dir_data, "cell_type_sample_table.png"), error = FALSE)
```
