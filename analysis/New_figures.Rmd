...
FeaturePlot(iPS_integrated, c("DYSF", "UTRN"), split.by = "Condition", pt.size = 0.3)
```

```{r VlnPlot_DYSF_UTRN, fig.width=13, fig.height=5}
p1 <- VlnPlot(iPS_integrated, c("DYSF"), group.by = "cell_type",split.by = "Condition") + NoLegend() + theme(axis.title.x = element_blank())
